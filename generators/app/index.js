...
(function() {
  ...
  copyFiles = function(fileName) {
    if (fileName.constructor === String) {
      this.src.copy(fileName, fileName);
    }
    if (fileName.constructor === Object) {
      return this.src.copy(fileName.file, "" + fileName.dest + fileName.file);
    }
  };
